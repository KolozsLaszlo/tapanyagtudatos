        ...
        <div className="py-20 w-full px-4">
          <div className="flex flex-col items-center z-20 md:flex-row">
            <div className="text-center mb-12 md:text-left md:w1/2 md:pr-10">
              <h1 className="title mb-4 text-white">Példa cím hosszú szöveggel</h1>
              <p className="leading-relaxed mb-10 text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae quos quidem non molestiae cupiditate soluta in, eligendi reiciendis et autem!</p>
            </div>
